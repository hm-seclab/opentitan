...
module xbar_peri (
  ...
  output tlul_pkg::tl_h2d_t tl_spi_device0_o,
  input  tlul_pkg::tl_d2h_t tl_spi_device0_i,
  output tlul_pkg::tl_h2d_t tl_spi_device1_o,
  input  tlul_pkg::tl_d2h_t tl_spi_device1_i,
  ...
  assign tl_spi_device0_o = tl_s1n_31_ds_h2d[9];
  assign tl_s1n_31_ds_d2h[9] = tl_spi_device0_i;

  assign tl_spi_device1_o = tl_s1n_31_ds_h2d[10];
  assign tl_s1n_31_ds_d2h[10] = tl_spi_device1_i;

  assign tl_spi_host0_o = tl_s1n_31_ds_h2d[11];
  assign tl_s1n_31_ds_d2h[11] = tl_spi_host0_i;

  assign tl_spi_host1_o = tl_s1n_31_ds_h2d[12];
  assign tl_s1n_31_ds_d2h[12] = tl_spi_host1_i;

  assign tl_rv_timer_o = tl_s1n_31_ds_h2d[13];
  assign tl_s1n_31_ds_d2h[13] = tl_rv_timer_i;

  assign tl_usbdev_o = tl_s1n_31_ds_h2d[14];
  assign tl_s1n_31_ds_d2h[14] = tl_usbdev_i;

  assign tl_pwrmgr_aon_o = tl_s1n_31_ds_h2d[15];
  assign tl_s1n_31_ds_d2h[15] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_31_ds_h2d[16];
  assign tl_s1n_31_ds_d2h[16] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_31_ds_h2d[17];
  assign tl_s1n_31_ds_d2h[17] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_31_ds_h2d[18];
  assign tl_s1n_31_ds_d2h[18] = tl_pinmux_aon_i;

  assign tl_ram_ret_aon_o = tl_s1n_31_ds_h2d[19];
  assign tl_s1n_31_ds_d2h[19] = tl_ram_ret_aon_i;

  assign tl_otp_ctrl_o = tl_s1n_31_ds_h2d[20];
  assign tl_s1n_31_ds_d2h[20] = tl_otp_ctrl_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_31_us_h2d.a_address &
      ...
      dev_sel_s1n_31 = 5'd8;
                  ...
                  ~(ADDR_MASK_SPI_DEVICE0)) == ADDR_SPACE_SPI_DEVICE0) begin
      dev_sel_s1n_31 = 5'd9;

    end else if ((tl_s1n_31_us_h2d.a_address &
                  ~(ADDR_MASK_SPI_DEVICE1)) == ADDR_SPACE_SPI_DEVICE1) begin
